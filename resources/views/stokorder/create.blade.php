        ...
        <div class="col-xl-12">
            ...
            <div class="panel panel-inverse" data-sortable-id="form-plugins-1">
                ...
                <div class="panel-body" style="padding: 5px">
                    <form class="form-horizontal form-bordered" style="margin-bottom: 1%; background: ghostwhite; padding: 1% 0 1% 0;" id="mydata" method="post" action="{{ url('barang') }}" enctype="multipart/form-data" >
                        @csrf 
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Stok Order</h4>
...
<script type="text/javascript">
        ...
        */
        ...
        $(document).ready(function() {
            ...
            $('#tampil-form').load("{{url('stokorder/modal')}}?id=0")
		});

        function edit_data(id){
            $('#tampil-form').load("{{url('stokorder/modal')}}?id="+id)
        }
                ...
                $.ajax({
                    ...
                    success: function(msg){
                        ...
                        if(bat[1]=='ok'){
                            ...
                            $('#tampil-form').load("{{url('stokorder/modal')}}?id=0")
                            var table=$('#data-table-fixed-header').DataTable();
			                    table.ajax.url("{{ url('stokorder/get_data')}}").load();    
                        }else{
                            document.getElementById("loadnya").style.width = "0px";
                            swal({
                                title: 'Notifikasi',
