    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="form-group row">
                <label style="padding: 1% 1% 2% 3%;" class="col-lg-3 col-form-label">Stok Awal / Sisa</label>
                <div class="col-lg-4" style="padding: 1% 1% 2% 1%;">
                    <div class="input-group input-group-sm">
                ...
                <div class="col-lg-4" style="padding: 1% 1% 2% 1%;">
                    <div class="input-group input-group-sm">
                        <input type="text" disabled class="form-control" name="sisa"   id="sisa" value="{{$data->sisa}}">
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        $("#sisa").inputmask({ alias : "currency", prefix: '', 'autoGroup': true, 'digits': 0, 'digitsOptional': false });
